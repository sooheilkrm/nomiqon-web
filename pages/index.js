    ...
    <>
      ...
      <section className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white py-20 px-4 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">
          {slogan?.sloganText || "Build your brand in seconds"}
        </h1>
        <p className="text-lg md:text-2xl mb-8 max-w-2xl mx-auto">
           {slogan?.sloganSubText || "Create stunning logos and full brand kits with the power of AI. No design skills required."}
         </p>
